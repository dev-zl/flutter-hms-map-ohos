...
abstract class HuaweiMapInitializer {
  ...
  /// Initializes the Map SDK and auto-detects the platform.
  ///
  /// This method automatically detects whether running on Android or HarmonyOS
  /// and configures the appropriate platform channels.
  ///
